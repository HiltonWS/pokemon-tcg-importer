...
from importer import __url_content_to_base64__, __update_database__, __get_cards__
from config import COLLECTION_SETS
...
def test_update_database(mock_db, mocker):
    ...
    data = {
        'set': {'id': 'set1', 'name': 'Set Name', 'series': 'Series Name'},
        'id': 'card1', 'number': '1', 'name': 'Card Name', 'image': 'image_url',
        'rarity': 'Common', 'eu_price': 1.0
    }
